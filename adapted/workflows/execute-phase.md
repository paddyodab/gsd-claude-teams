...
```bash
node ~/.claude/get-shit-done/bin/gsd-tools.cjs commit "docs(phase-{X}): complete phase execution" --files .planning/ROADMAP.md "$(node ~/.claude/get-shit-done/bin/gsd-tools.cjs state-path)" .planning/REQUIREMENTS.md {phase_dir}/*-VERIFICATION.md
```
</step>
